...
const servers = [
{
  ...
  verified:true,
  score:4.9,
  image:"https://via.placeholder.com/600x300?text=SAB+France",
...
},
{
  ...
  verified:true,
  score:4.7,
  image:"https://via.placeholder.com/600x300?text=Guigui",
...
},
{
  ...
  verified:true,
  score:4.5,
  image:"https://via.placeholder.com/600x300?text=Azurix",
...
},
{
  ...
  verified:true,
  score:4.4,
  image:"https://via.placeholder.com/600x300?text=Azen",
...
},
{
  ...
  verified:true,
  score:4.3,
  image:"https://via.placeholder.com/600x300?text=NOVA+Anti-Scam",
...
if(container){
  servers.forEach(s=>{
    ...
    <div class="card">
      ...
      <img src="${s.image}" alt="${s[lang].name}" style="border-radius:8px; margin:10px 0; width:100%;">
